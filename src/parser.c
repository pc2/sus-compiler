...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    ...
    [sym_block] = STATE(6),
    [sym__assign_left_side] = STATE(162),
    [sym_decl_assign_statement] = STATE(161),
    [sym_decl_statement] = STATE(161),
    [sym_expression_statement] = STATE(161),
    [sym_if_statement] = STATE(6),
    [sym_for_statement] = STATE(6),
    [sym__statement] = STATE(6),
    [aux_sym_block_repeat1] = STATE(6),
    [aux_sym__assign_left_side_repeat1] = STATE(17),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(133)] = 3416,
  [SMALL_STATE(134)] = 3422,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [37] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(10),
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(45),
  ...
  [49] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(57),
  [52] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(66),
  ...
  [60] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(17),
  [63] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(33),
  [66] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(14),
  ...
  [76] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_global_identifier_repeat1, 2),
  [78] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_global_identifier_repeat1, 2), SHIFT_REPEAT(153),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_global_identifier_repeat1, 2),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_global_identifier, 1),
  [85] = {.entry = {.count = 1, .reusable = false}}, SHIFT(153),
  [87] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_global_identifier, 1),
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_global_identifier, 2),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_global_identifier, 2),
  [93] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_global_identifier, 3),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_global_identifier, 3),
  ...
  [117] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_op, 3, .production_id = 13),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_op, 3, .production_id = 13),
  [121] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_array_op, 4, .production_id = 20),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_op, 4, .production_id = 20),
  [125] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_call, 4, .production_id = 19),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_call, 4, .production_id = 19),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_call, 5, .production_id = 25),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_call, 5, .production_id = 25),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_op, 2, .production_id = 7),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_op, 2, .production_id = 7),
  [137] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_call, 3, .production_id = 12),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_call, 3, .production_id = 12),
  ...
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 4, .production_id = 15),
  [172] = {.entry = {.count = 1, .reusable = false}}, SHIFT(58),
  [174] = {.entry = {.count = 1, .reusable = false}}, SHIFT(64),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 3, .production_id = 11),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 3, .production_id = 11),
  ...
  [186] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 5, .production_id = 21),
  [188] = {.entry = {.count = 1, .reusable = false}}, SHIFT(159),
  [190] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 5, .production_id = 23),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 5, .production_id = 23),
  [194] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_for_statement, 5, .production_id = 24),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_statement, 5, .production_id = 24),
  [198] = {.entry = {.count = 1, .reusable = false}}, SHIFT(15),
  [200] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__assign_left_side, 1),
  [202] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_statement, 1),
  [204] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [206] = {.entry = {.count = 1, .reusable = true}}, SHIFT(91),
  [208] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_global_identifier_repeat1, 2), SHIFT_REPEAT(159),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__assign_left_side, 2),
  [213] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [215] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [217] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__statement, 2),
  [219] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement, 2),
  ...
  [249] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__assign_left_side_repeat2, 3),
  [251] = {.entry = {.count = 1, .reusable = true}}, SHIFT(83),
  [253] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__assign_left_side_repeat2, 2),
  ...
  [279] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_func_call_repeat1, 2),
  [281] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_decl_assign_statement, 3, .production_id = 14),
  ...
  [301] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_range, 3, .production_id = 26),
  ...
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 4, .production_id = 6),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 2),
  [328] = {.entry = {.count = 1, .reusable = false}}, SHIFT(107),
  [330] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 3, .production_id = 9),
  [332] = {.entry = {.count = 1, .reusable = true}}, SHIFT(72),
  [334] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 2, .production_id = 5),
  ...
  [349] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 3, .production_id = 6),
  ...
  [359] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(152),
  [362] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__assign_left_side, 2),
  [366] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [368] = {.entry = {.count = 1, .reusable = true}}, SHIFT(99),
  [370] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 2, .production_id = 2),
  [372] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_interface_ports_repeat1, 2), SHIFT_REPEAT(103),
  [375] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_interface_ports_repeat1, 2),
  [377] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__assign_left_side, 3),
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__assign_left_side, 1),
  [381] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_decl_statement, 1),
  [383] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__assign_left_side_repeat2, 2), SHIFT_REPEAT(15),
  [386] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__assign_left_side_repeat2, 2),
  [388] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 6, .production_id = 22),
  [390] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_func_call_repeat1, 2), SHIFT_REPEAT(68),
  [393] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_func_call_repeat1, 2),
  [395] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 5, .production_id = 18),
  [397] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 4, .production_id = 8),
  [399] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 3, .production_id = 4),
  [401] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__assign_left_side_repeat2, 3),
  [403] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 5, .production_id = 17),
  [405] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [407] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [409] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interface_ports, 4, .production_id = 10),
  [411] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [413] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_type, 4, .production_id = 16),
  [415] = {.entry = {.count = 1, .reusable = true}}, SHIFT(105),
  [417] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [419] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 3, .production_id = 1),
  [421] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 4, .production_id = 3),
