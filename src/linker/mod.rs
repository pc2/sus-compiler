...
impl LinkInfo {
    // TODO: fix full name resolution, currently assumes everything is global
    // how to get full File path in this context?
    pub fn get_full_name(&self) -> String {
        format!("::{}", self.name)
        //let pathvec = self.self.file;
    }
...
//        self.global_namespace.get(&self.files[])
    ...
    fn for_all_duplicate_declaration_errors(
        ...
        let mut file_path = self.files[file_uuid].file_identifier.clone();
        //file_path.reverse();
